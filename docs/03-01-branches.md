...
![Source Control Graph: последовательные коммиты ветки main, последний содержит гистограмму. Команда подготовки: python3 bin/create_course_project.py /tmp/git-course-branches --state histogram]()
