...
[Откройте окно истории](#git-log) и выберите в фильтре сверху показывать все ветки [(all branches)]{.figtext}.
...
Если в обеих ветках была отредактирована одна и та же строка, Git выдаст сообщение о конфликте -
его нужно устранить, отредактировав эту строку предпочтительным образом и создать коммит вручную.
...
Наша задача переписать выделенный участок в одну версию, как мы считаем нужным, и убрать спецсимволы.
