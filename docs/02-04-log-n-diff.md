...
Чтобы открыть журнал, нажмите кнопку [History]{.figtext} на панели [Git]{.figtext}.
...
Если нажать кнопку [View file]{.figtext} справа от названия файла, можно увидеть его полное содержимое, каким оно было зафиксировано создания коммита.
