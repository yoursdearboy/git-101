...
**Вопрос 1. Сколько коммитов вы видите в окне истории?**
...
**Вопрос 2. Сколько строк было изменено в последнем коммите для сохранения гистограммы?**

*(Проверим, что поняли как читать diff)*

- Удалены три строки, добавлены две строки
- Удалены две строки
- Удалены две строки, добавлены две строки
