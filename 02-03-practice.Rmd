...
Итак, мы выполнили несколько шагов анализа данных. Давайте посмотрим на сделанные изменения с помощью средств Git. [Далее](#git-log).
...
**Вопрос 3: Каким цветом были выделены изменения?**

- Все одним цветом
- Красным выделяются удаленные строки, зеленым добавленные
