# Практикум по Git и тулам для ИБ
...
Курс «Основы Git » продолжает учебный проект курса «Введение в автоматизацию обработки данных на R»: студенты сохраняют накопленные файлы в Git и продолжают анализ пингвинов.
