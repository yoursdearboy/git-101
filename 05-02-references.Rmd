...
- [Документация Positron](https://positron.posit.co/welcome.html) --- официальное руководство по интерфейсу Positron.
- [Git Version Control](https://positron.posit.co/git.html) --- работа с Git в Positron.
- [Quarto](https://positron.posit.co/quarto.html) --- работа с документами `.qmd` в Positron.
